	...
	FAMILY.beliefs = {
		...
		[3] = {
			...
			["taste_of_blood"] = {
				name = "Taste of Blood",
				subfaith = "Faith of the Old Son",
				description = "Увеличивает ваше максимальное здоровье на 35 очков. При нанесении урона персонажу, он будет подсвечен красным на 3 минуты. В это время вы нанесете ему на 10% больше урона. Вы можете отслеживать только одного человека одновременно.",
			...
			["daring_trout"] = {
				...
				subfaith = "Faith of the Old Son",
				description = "Улучшает способность «Боевой клич»: все ближайшие враги будут подсвечены белым на 10 секунд и замедлены на 15%. Увеличивает урон от метательного топора на 15%. Открывает доступ к семейным ритуалам II уровня и уникальным ритуалам Старшего Сына.",
		...
		[5] = {
			...
			["shedskin"] = {
				...
				subfaith = "Faith of the Sister",
				description = "Увеличивает максимальное здоровье на 25 единиц. Увеличивает значение защиты всех доспехов на 15%. Открывает ритуалы Веры Семьи и Веры Тьмы II уровня, а также уникальные ритуалы Веры Сестер.",
			...
			["deceitful_snake"] = {
				...
				subfaith = "Faith of the Sister",
				description = "Если кто-то нанесет вам 10 или более единиц урона за один удар, он будет выделен красным и будет получать от вас на 40% больше урона в течение 40 секунд. Также разблокирует способность выплавлять Адскую Сталь (только если также разблокирован «Мастер-кузнец»).",
