...
function ENT:HUDPaintTargetID(x, y, alpha)
	...
	y = Clockwork.kernel:DrawInfo("Врата в другое измерение.", x, y, colorWhite, alpha);
end;
...
local function CreateMenu(state)
	...
	local subMenu = menu:AddSubMenu("Отправиться к...");
	
	subMenu:AddOption("..Арке Погибели.", function() Clockwork.Client:ConCommand("cw_HellPortalArch") end);
	subMenu:AddOption("..Столпам Творения.", function() Clockwork.Client:ConCommand("cw_HellPortalPillars") end);
