...
cwLimbs.limbStates = {
	["head"] = {
		...
		["Покалечена"] = {name = "Покалечена", effects = "Очень Замутненное зрение\nЭкстремальное Шатание\nУвеличенный Шанс Травм"},
	},
	["torso"] = {
		["В порядке"] = {name = "В порядке", effects = "Нет"},
		["slightly_damaged"] = {name = "Немного Повреждена", effects = "Увеличенный Шанс Травм"},
		["Повреждена"] = {name = "Повреждена", effects = "Увеличенный Шанс Травм"},
		...
		["Покалечена"] = {name = "Покалечена", effects = "Гарантированная Травма"},
	},
	["arms"] = {
		["В порядке"] = {name = "В порядке", effects = "Нет"},
		["slightly_damaged"] = {name = "Немного Повреждена", effects = "Увеличенный Шанс Травм"},
		["Повреждена"] = {name = "Повреждена", effects = "Немного Увеличенное Потребление Выносливости\nУвеличенный Шанс Травм"},
	...
	["legs"] = {
		...
		["Покалечена"] = {name = "Покалечена", effects = "Нельзя Перекатываться\nНельзя Бежать\nМожно Ходить Только Гуськом\nНельзя Прыгать\nСильно Уменьшенное Сопротивление Урону по Стабильности\nШанс Случайного Падения\nГарантированная Травма"},
	},
};
